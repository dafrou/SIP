...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Formulario de Aprobador</title>
        ...
        <link href="../../styles/formAprobador.css" rel="stylesheet" type="text/css"/>      
            ...
            <div class="container marketing">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="col-lg-8">
                            <p id="Label6" class="titulo">FORMULARIO DE APROBADOR DE INGRESO</p>
                        </div>
                        <div class="col-lg-2">
                    ...
                    <div class="col-lg-12">
                        <div class="col-lg-1"></div>
                        <div class="col-lg-2">
                            <p id="Label2" class="formulario">Datos Aprobador</p>
                        </div>
                        <div class="col-lg-4">
